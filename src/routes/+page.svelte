...
<nav class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-header border-b border-neutral-200">
	<div class="container">
		<div class="flex items-center justify-between h-16">
			...
			<!-- Mobile menu button -->
			<div class="md:hidden">
				<button onclick={toggleNav} class="text-neutral-600 hover:text-neutral-900" aria-label="Toggle mobile menu">
		...
		<div class="text-center max-w-4xl mx-auto">
			...
			<div class="fade-in animation-delay-600 grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
				...
				<div class="text-center">
					<div class="medical-icon mx-auto mb-4">
						<svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.5a2.5 2.5 0 000-5H9m0 0v12m6-12v12M9 5H6.5a2.5 2.5 0 000 5H9" />
						</svg>
					</div>
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
			{#each teamMembers as member, index}
				<div class="team-card fade-in" style="animation-delay: {index * 100}ms">
					<div class="w-20 h-20 bg-gradient-to-br from-primary-400 to-healthcare-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl font-semibold">
...
<footer class="bg-neutral-900 text-white py-12">
	<div class="container">
		...
		<div class="border-t border-neutral-800 mt-8 pt-8 text-center text-neutral-400">
			<p>&copy; 2024 Auracare. All rights reserved.</p>
		</div>
	</div>
</footer>
